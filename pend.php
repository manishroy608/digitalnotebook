...
<div id="container">
	...
	$adm=$rows['class'];
	if($adm=='ADMIN'){
	$query="select * from cyberwolf  WHERE  track !='DONE' AND date between '2018-06-02' AND '2018-12-30' ORDER BY date DESC";
	$result=mysqli_query($conn,$query);
	}
	...
	<tr>
	<th colspan="20" align="center" bgcolor="#00C8FF"><h2><strong><center>Pending Entry Here</center></strong></h2></th>
	</tr>
